...
// bar chart
	...
	$("#submit").click(function(){				
		...
		city_name = $("#city_name").val(); //# signifies input receival from form; val method returns this input using the object (asks for value)
		...
		$.post("insert.php", 
          {
            ...
            $("#message").html(data).fadeIn(2000).delay(3000).fadeOut(2000,function() {
               location.reload();
              }); //reloads the page after input has been made so that the user input is reflected in graph
          }
        );
	});
...
<form id="city_form" method="POST">
	...
	<div>
	<div>City: </div>
	<input type="text" id="city_name" value=""><br>
	</div>
	
	<div>
	<div>Country ID: </div>
	<input type="text" id="country_id" value=""><br>
	</div>
	<br>
